...
function TopBar() {
  return (
    <header className="flex h-[52px] items-center gap-3 px-3">
      <button className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-white text-2xl font-black text-[#111827] shadow-[0_5px_14px_rgba(15,23,42,0.16)]">
        &lt;
      </button>
        ...
        <div className="mt-1 flex items-center gap-3">
          ...
          <div className="flex gap-[5px]">
            {[0, 1, 2, 3].map((item) => (
              <span
                key={item}
                className="h-[5px] w-[38px] rounded-full bg-[#ff4d5f]"
              />
            ))}
          </div>
      ...
      <button className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-white shadow-[0_4px_12px_rgba(15,23,42,0.14)]">
  ...
  return (
    <section className="relative mt-0 h-[235px] overflow-hidden">
      <Image
        ...
        alt="Birthday cafe stage with Lily character"
        width={550}
        height={235}
        priority
        className="h-full w-full object-cover"
  ...
  return (
    <section className="relative -mt-px mx-3 h-[232px] rounded-[24px] bg-white px-7 pt-5 shadow-[0_8px_24px_rgba(15,23,42,0.14)]">
      ...
      <div className="absolute bottom-8 left-7 rounded-full bg-[#fff2d7] px-3 py-2 text-[12px] font-bold text-[#6b4d16]">
        It&apos;s your turn! Tap the mic and say the line above.
      </div>
...
function MicDock() {
  return (
    <section className="relative h-[155px]">
      <button className="absolute left-[68px] top-[22px] flex flex-col items-center gap-3">
        ...
        <span className="text-[14px] font-semibold text-[#7c8493]">Listen Again</span>
      </button>
      <button className="absolute left-1/2 top-[-18px] flex -translate-x-1/2 flex-col items-center">
        <span className="grid h-[132px] w-[132px] place-items-center rounded-full bg-[#fff2ef] ring-[8px] ring-[#fff7f5]">
          <span className="relative grid h-[106px] w-[106px] place-items-center rounded-full bg-[#ff564f] shadow-[0_12px_28px_rgba(255,86,79,0.33)] ring-[4px] ring-white">
      ...
      <button className="absolute right-[79px] top-[22px] flex flex-col items-center gap-3">
        ...
        <span className="text-[14px] font-semibold text-[#7c8493]">Hints</span>
      </button>
    </section>
  );
}
    ...
    <section className="mx-3 mt-5 flex h-[113px] items-center rounded-[14px] border-2 border-[#28c269] bg-white px-3 shadow-sm">
      ...
      <div className="ml-4 min-w-0 flex-1">
        ...
        <div className="mt-2 truncate text-[12px] font-semibold text-[#3f4654]">
          You expressed emotion naturally!
        </div>
      </div>
      <button className="ml-2 h-[52px] rounded-full bg-[#36c765] px-5 py-3 text-[14px] font-black text-white shadow-[0_8px_16px_rgba(54,199,101,0.22)]">
        View Card
      </button>
    </section>
  );
...
function BottomNav() {
  return (
    <nav className="absolute bottom-0 left-0 right-0 flex h-[47px] items-center justify-around border-t border-[#e9edf3] bg-white text-[13px] font-semibold text-[#111827]">
      <button>Scene Info</button>
      <button className="relative">
        Chat
        <span className="absolute -right-4 -top-2 h-2 w-2 rounded-full bg-[#ff4d5f]" />
      </button>
      <button className="text-[#ff4d5f]">Leave Room</button>
    </nav>
  );
}

export default function PlayImplementationPreviewPage() {
  return (
